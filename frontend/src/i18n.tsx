...
const messages: Record<Lang, MessageTree> = {
  en: {
    ...
    update: {
      ...
      dismiss: "Dismiss",
      noCompatibleAsset: "No compatible Windows executable was found for this release.",
      autoInstallUnavailable: "Automatic install is unavailable for this build.",
      openRelease: "Open Release",
      notStarted: "Update install did not start.",
      restarting: "Update downloaded. The app will restart to apply it.",
      toastAvailable: "New version {version} is available.",
      toastLatest: "Already up to date ({version}).",
  ...
  zh: {
    ...
    update: {
      ...
      installing: "安装中…",
      dismiss: "忽略",
      noCompatibleAsset: "这个 Release 里没有匹配的 Windows exe 资产。",
      autoInstallUnavailable: "当前构建不支持自动安装。",
      openRelease: "打开 Release",
      notStarted: "更新安装未启动。",
      restarting: "更新已下载，应用即将重启并替换 exe。",
      toastAvailable: "发现新版本 {version}。",
